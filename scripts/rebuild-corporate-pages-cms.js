...
const pages = [
  { slug: "executives", title: "ผู้บริหารหน่วยงาน", path: "src/app/[lang]/about/executives/page.tsx" },
  { slug: "policies", title: "นโยบายและยุทธศาสตร์", path: "src/app/[lang]/about/policies/page.tsx" },
  { slug: "vision", title: "วิสัยทัศน์ พันธกิจ", path: "src/app/[lang]/about/vision/page.tsx" },
  { slug: "structure", title: "โครงสร้างหน่วยงาน", path: "src/app/[lang]/about/structure/page.tsx" },
  { slug: "pdpa", title: "PDPA (คลิกเพื่ออ่านพ.ร.บ.คุ้มครองข้อมูลส่วนบุคคล)", path: "src/app/[lang]/about/pdpa/page.tsx" },
  { slug: "projects", title: "แผนงานและโครงการ", path: "src/app/[lang]/projects/page.tsx" }
];
...
export default async function DynamicCorporatePage(props: { params: Promise<{ lang: string }> }) {
  ...
  const pageData = await prisma.pageContent.findUnique({ where: { slug: "${p.slug}" } });
    ...
    <div className="flex flex-col font-sans">
      <div className="bg-gradient-to-br from-primary to-blue-900 py-24 text-white text-center relative overflow-hidden shadow-inner">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4 drop-shadow-lg">{pageData?.title || "${p.title}"}</h1>
  ...
  console.log('Migrated static component to Dynamic Database Page:', p.slug);
});
