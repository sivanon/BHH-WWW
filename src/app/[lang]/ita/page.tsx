...
export default async function ITAPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const descriptions = [
    "ประเมินการเผยแพร่ข้อมูลที่เป็นปัจจุบันบนเว็บไซต์ของหน่วยงาน",
    "ประเมินความโปร่งใสในการจัดซื้อจัดจ้าง การจัดทำแผน การวิเคราะห์ผล",
    "การบริหารงานบุคคล การพัฒนาบุคลากร และการประเมินผลการปฏิบัติราชการ",
    "การส่งเสริมความโปร่งใสในการปฏิบัติงานและการให้บริการ",
    "มาตรการและแนวปฏิบัติเพื่อป้องกันการรับสินบน",
    "มาตรการและแนวปฏิบัติเพื่อป้องกันการใช้ทรัพย์สินของส่วนรวม",
    "การประเมินความเสี่ยงและแผนป้องกันการทุจริต",
    "มาตรการและแนวปฏิบัติเพื่อป้องกันผลประโยชน์ทับซ้อน",
    "การสร้างวัฒนธรรมองค์กรที่ต่อต้านการทุจริตแบบเชิงรุก"
  ];
