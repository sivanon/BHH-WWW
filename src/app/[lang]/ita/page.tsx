...
export default async function ITAPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const descriptions = [
    "ประเมินการปฏิบัติหน้าที่ของบุคลากรภายในหน่วยงาน",
    "ประเมินความโปร่งใสในการใช้งบประมาณของหน่วยงาน",
    "ประเมินเกี่ยวกับการใช้อำนาจของผู้บริหาร",
    "ประเมินเกี่ยวกับการใช้ทรัพย์สินของทางราชการ",
    "ความโปร่งใสและกระบวนการแก้ไขปัญหาการทุจริต",
    "ประเมินคุณภาพการดำเนินงานและการให้บริการ",
    "ประเมินประสิทธิภาพการสื่อสารภายในและภายนอก",
    "มาตรการและกระบวนการในการปรับปรุงระบบการทำงาน",
    "ประเมินการเผยแพร่และเปิดเผยข้อมูลที่เป็นปัจจุบัน",
    "การประเมินความเสี่ยงและมาตรการป้องกันการทุจริต"
  ];
